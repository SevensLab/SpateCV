...
def stPlus(spatial_df, scrna_df, genes_to_predict, save_path_prefix='./stPlus',
    ...
    # train_loader = DataLoader(dataset=train_set, batch_size=batch_size, shuffle=True, num_workers=4, generator=torch.Generator(device = 'cpu'))
    # val_loader = DataLoader(dataset=train_set, batch_size=batch_size, shuffle=False, num_workers=4,generator=torch.Generator(device = 'cpu'))
